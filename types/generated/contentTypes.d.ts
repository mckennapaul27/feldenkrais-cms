...
export interface ApiBenefitPageBenefitPage extends Schema.CollectionType {
  collectionName: 'benefit_pages';
  info: {
    singularName: 'benefit-page';
    pluralName: 'benefit-pages';
    displayName: 'benefitPage';
  };
  options: {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::benefit-page.benefit-page', 'title'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::benefit-page.benefit-page',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiClassClass extends Schema.CollectionType {
  ...
  attributes: {
    practitioners: Attribute.Relation<
      'api::class.class',
      'manyToMany',
      'api::practitioner.practitioner'
    >;
    extraNotes: Attribute.RichText;
...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    navLink: Attribute.Component<'layout.nav-link', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPractitionerPractitioner extends Schema.CollectionType {
  ...
  attributes: {
    ...
    regions: Attribute.Relation<
      ...
      'api::location.location'
    >;
    slug: Attribute.UID<'api::practitioner.practitioner', 'name'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::benefit-page.benefit-page': ApiBenefitPageBenefitPage;
